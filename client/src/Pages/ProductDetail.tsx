...
const ProductDetail: React.FC = () => {
  ...
  const [productQuery, variationsQuery] = useQueries({
    queries: [
      { queryKey: ['product', id], queryFn: () => fetchProduct(id), retry: 2 },
      {
  ...
  const increaseQty = () => {
    ...
    if (!isNaN(parsedQty)) setQuantity((parsedQty + 1).toString());
    else setQuantity('1');
  };
  ...
  useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      else if (event.key === 'Escape') closeImageView();
    };
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              ...
              {reviews.length > 0 ? (
                ...
                <p className="text-center text-lg text-gray-500 italic py-8 bg-white rounded-xl shadow-sm border border-gray-100">
