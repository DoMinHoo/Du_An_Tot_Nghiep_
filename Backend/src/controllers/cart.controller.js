...
const Product = require('../models/products.model'); // Sửa thành số ít

// 1. Thêm sản phẩm vào giỏ hàng
exports.addToCart = async (req, res) => {
    try {
        const { productId, quantity } = req.body;
        const userId = req.user.userId; // Sửa thành userId để khớp với payload JWT
...
exports.updateCartItem = async (req, res) => {
    try {
        const { productId, quantity } = req.body;
        const userId = req.user.userId; // Sửa thành userId
