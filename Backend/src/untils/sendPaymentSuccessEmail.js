        ...
        const mailOptions = {
            ...
            html: `
                <div style="max-width: 600px; margin: 0 auto; padding: 20px; font-family: 'Roboto', Arial, sans-serif; color: #333;">
                    ...
                    <ul style="list-style: none; padding-left: 0; margin-bottom: 20px;">
                        <li style="margin-bottom: 10px;"><strong>Mã đơn hàng:</strong> ${order.orderCode}</li>
                        <li style="margin-bottom: 10px;"><strong>Phương thức thanh toán:</strong> ${order.paymentMethod === 'online_payment' ? 'Thanh toán bằng ZaloPay' : order.paymentMethod === 'cod' ? 'Thanh toán khi nhận hàng' :  order.paymentMethod ==='wallet' ? 'Thanh toán bằng ví' : 'Chuyển khoản'  } </li>
                        <li style="margin-bottom: 10px;"><strong>Trạng thái:</strong> ${statusTranslations[newStatus] || newStatus}</li>
                        <li style="margin-bottom: 10px;"><strong>Địa chỉ giao hàng:</strong> ${order.shippingAddress.ward}, ${order.shippingAddress.district}, ${order.shippingAddress.province},${order.shippingAddress.addressLine}</li>
